...
class ContatosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contato' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-03-31 16:05:44',
            'modified' => '2017-03-31 16:05:44'
        ],
    ];
}
