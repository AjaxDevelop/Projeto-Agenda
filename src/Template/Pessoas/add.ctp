...
/**
  ...
  */
    ...
    //Validação.
    echo $this->Html->script('Agenda.pessoas/validacao_add');
...
<?= $this->Form->create(null, ['name' => 'form_empresa', 'id' => 'form_empresa']) ?>
    ...
    <div class="row">
        ...
        <div class="input-field col l2 m6 s12">
            ...
            echo $this->Form->input('cpf_cnpj',[
                ...
                'type' => 'text',
                'id' => 'cnpj',
                'class'=>'verificarCliente cnpj_mask',
                'required' => true,
                'tabindex'=>$tabindex
            ]);
            ++$tabindex;
...
<div id="tab-socios">
    ...
    <div class="row">
        ...
        <input type="hidden" id="socios_count" value="0">
    </div>
            ...
            <div class="col l3 m4 s6 offset-l7 offset-m4">
                <?php
                    echo $this->Form->button('Salvar<i class="material-icons right">cloud</i>', [
                        'type' => 'button',
                        'id' => 'salvar',
                        'class'=>'waves-effect waves-light btn disabled right',
                        'tabindex'=>$tabindex
                    ]);
                    ++$tabindex;
                ?>
